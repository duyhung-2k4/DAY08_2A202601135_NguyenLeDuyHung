...
def rerank(
    ...
    if method == "cross_encoder":
        ...
        # `candidates` ở đây là 1 list duy nhất (interface chung nhận 1 list).
        # Bọc thành ranked_lists=[candidates] để tái dùng rerank_rrf(); khi cần
        # fuse nhiều ranker (semantic + lexical) thì gọi rerank_rrf() trực tiếp
        # với nhiều list, như task9_retrieval_pipeline.py đang làm.
